...
def main():
	...
	# N = 5
	# A = 4
	print("Entrez la taille du plateau et le nombre de pions à aligner pour gagner")
	N = EntrerUnNombre("\tTaille du plateau (<=10) => ")
	A = EntrerUnNombre("\tNombre de pions => ")
	while N>10 or A>N : 	
		print("Valeurs incorrectes, reessayez :")
		N = EntrerUnNombre("\tTaille du plateau (<=10) => ")
		A = EntrerUnNombre("\tNombre de pions => ")
	P = []
	InitPosition(N, P)
